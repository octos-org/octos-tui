...
# 0.2.3-rc.1/v0.2.3-rc.1/__SHA_*__ placeholders from that prerelease's assets. The
...
class OctosTuiDev < Formula
  ...
  if OS.mac? && Hardware::CPU.arm?
    url "https://github.com/octos-org/octos-tui/releases/download/v0.2.3-rc.1/octos-tui-aarch64-apple-darwin.tar.xz"
    sha256 "c975a478f6808074896704a7573103761aa10300394fd09bec2d2e962d196b6e"
  end
  if OS.linux?
    if Hardware::CPU.arm?
      url "https://github.com/octos-org/octos-tui/releases/download/v0.2.3-rc.1/octos-tui-aarch64-unknown-linux-gnu.tar.xz"
      sha256 "ff4b7b80f96aeb556591590045078ab863d4c41dfb7552f9ff11b0169bf78f62"
    end
    if Hardware::CPU.intel?
      url "https://github.com/octos-org/octos-tui/releases/download/v0.2.3-rc.1/octos-tui-x86_64-unknown-linux-gnu.tar.xz"
      sha256 "b14fd7914081bc0d5049dcb784c769098052702fb197ab30e094889b3a4b00e3"
    end
  end
  license "Apache-2.0"
